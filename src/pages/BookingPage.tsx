...
const BookingPage: React.FC = () => {
  ...
  const fetchAvailability = useCallback(async () => {
    ...
    try {
      ...
      const slots = await api<string[]>(
        `/appointments/availability?date=${dateString}&serviceId=${selectedService._id}`
      );
      ...
      <div className="w-full max-w-4xl bg-brand-dark rounded-xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/3 bg-brand-light-dark p-8 text-white flex flex-col">
          ...
          <div className="space-y-4 mt-4 text-brand-gray flex-grow">
            ...
            <div
              className={`flex items-center space-x-3 ${
                step >= 3 && selectedTime ? "text-brand-gold" : ""
              }`}
            >
        ...
        <div className="w-full md:w-2/3 p-8">
          ...
          {step === 1 && (
            <div>
              <h3 className="text-2xl font-bold mb-6 flex items-center">
                <UserIcon className="w-6 h-6 mr-2 text-brand-gold" /> 1. Seus
                Dados
              </h3>
              ...
              <button
                ...
                className="mt-8 w-full bg-brand-gold text-brand-dark font-bold py-3 rounded-md hover:bg-brand-light-gold transition disabled:bg-gray-500 disabled:cursor-not-allowed"
              >
                Próximo
              </button>
            </div>
          ...
          {step === 2 && (
            <div>
              <h3 className="text-2xl font-bold mb-6 flex items-center">
                <ScissorsIcon className="w-6 h-6 mr-2 text-brand-gold" /> 2.
                Escolha o Serviço
              </h3>
                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg text-left border-2 transition ${
                      selectedService?._id === service._id
                        ...
                        : "bg-brand-light-dark border-brand-gold/30 hover:border-brand-gold"
                    }`}
                  >
              ...
              <button
                onClick={() => setStep(1)}
                className="mt-8 w-full bg-brand-gray/20 text-brand-gray font-bold py-3 rounded-md hover:bg-brand-gray/40 transition"
              >
                Voltar
              </button>
            </div>
          ...
          {step === 3 && (
            <div>
              <h3 className="text-2xl font-bold mb-6 flex items-center">
                <CalendarIcon className="w-6 h-6 mr-2 text-brand-gold" /> 3.
                Escolha Data e Hora
              </h3>
              <input
                type="date"
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 max-h-60 overflow-y-auto">
                {isLoadingSlots ? (
                  ...
                  <p className="col-span-full text-center text-brand-gray">
              ...
              <div className="flex gap-4 mt-8">
                <button
                  ...
                  className="w-full bg-brand-gray/20 text-brand-gray font-bold py-3 rounded-md hover:bg-brand-gray/40 transition"
                >
                  Voltar
                </button>
                <button
                  ...
                  className="w-full bg-brand-gold text-brand-dark font-bold py-3 rounded-md hover:bg-brand-light-gold transition disabled:bg-gray-500 disabled:cursor-not-allowed"
                >
